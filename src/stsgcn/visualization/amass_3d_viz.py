...
from stsgcn.datasets import Amass_3D_Dataset
...
def visualize(model, device, cfg):
    ...
    loader = Amass_3D_Dataset(data_dir, input_n, output_n, skip_rate, body_model_dir, actions=None, split=2)
    ...
    for cnt, batch in enumerate(loader): 
        ...
        sequences_train = batch[:, 0:input_n, joint_used, :]
        ...
        line_anim.save(os.path.join(cfg["log_dir"], cfg["experiment_time"], f'human_viz_{cnt}.gif'), writer='pillow')
