            ...
            for action_idx in np.arange(len(acts)):
                ...
                if self.split <= 1:
                    for subact in [1, 2]:  # subactions
                        ...
                        the_sequence = torch.from_numpy(the_sequence).float().to(self.device)
                    ...
                    the_seq1 = torch.from_numpy(the_sequence1).float().to(self.device)
                    the_seq1[:, 0:6] = 0
                    ...
                    the_seq2 = torch.from_numpy(the_sequence2).float().to(self.device)
                    the_seq2[:, 0:6] = 0
